...
export const dict = {
  ...
  "profile.action.login": "使用 Relay 登入",
  ...
  "settings.aboutKiloCode.title": "關於 Relay",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Relay 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "Relay 擴充功能",
  ...
  "settings.language.description": "選擇 Relay 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 Relay 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Relay 新功能",
