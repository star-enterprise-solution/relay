export const dict = {
  ...
  "deviceAuth.title": "Se connecter à Relay",
  ...
  "profile.action.login": "Se connecter avec Relay",
  ...
  "settings.aboutKiloCode.title": "À propos de Relay",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Relay est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutKiloCode.extensionName": "Extension Relay",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Relay. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Relay, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Relay",
