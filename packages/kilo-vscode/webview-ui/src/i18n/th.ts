export const dict = {
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Relay",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Relay",
  ...
  "settings.aboutKiloCode.title": "เกี่ยวกับ Relay",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "Relay เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutKiloCode.extensionName": "ส่วนขยาย Relay",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Relay "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Relay ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Relay",
