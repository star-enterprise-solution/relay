export const dict = {
  ...
  "deviceAuth.title": "Accedi a Relay",
  ...
  "profile.action.login": "Accedi con Relay",
  ...
  "settings.aboutKiloCode.title": "Informazioni su Relay",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Relay è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Estensione Relay",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Relay. "Auto" usa la lingua di VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Relay, incluse API key dei provider e modello predefinito.",
  ...
  "migration.whatsNew.title": "Novità in Relay",
