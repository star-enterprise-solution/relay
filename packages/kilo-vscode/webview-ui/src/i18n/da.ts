export const dict = {
  ...
  "deviceAuth.title": "Log ind på Relay",
  ...
  "profile.action.login": "Log ind med Relay",
  ...
  "session.messages.welcome":
    "Relay er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Relay-udvidelse",
  ...
  "settings.language.description": 'Vælg sproget til Relay-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Relay, herunder udbyder API-nøgler og standardmodel.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Relay",
