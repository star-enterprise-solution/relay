export const dict = {
  ...
  "deviceAuth.title": "Iniciar sesión en Relay",
  ...
  "profile.action.login": "Iniciar sesión con Relay",
  ...
  "settings.aboutKiloCode.title": "Acerca de Relay",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Relay es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensión Relay",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Relay. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Relay, incluyendo las claves API de proveedores y el modelo predeterminado.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Relay",
