export const dict = {
  ...
  "profile.action.login": "Relayでログイン",
  ...
  "settings.aboutKiloCode.title": "Relayについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "RelayはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutKiloCode.extensionName": "Relay拡張機能",
  ...
  "settings.language.description": "Relay UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたRelayから設定を移行します。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Relayの新機能",
