export const dict = {
  ...
  "deviceAuth.title": "Entrar no Relay",
  ...
  "profile.action.login": "Entrar com Relay",
  ...
  "settings.aboutKiloCode.title": "Sobre o Relay",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Relay é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão Relay",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Relay. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Relay, incluindo chaves de API de provedor e modelo padrão.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Relay",
