export const dict = {
  ...
  "deviceAuth.title": "Войти в Relay",
  ...
  "profile.action.login": "Войти через Relay",
  ...
  "settings.aboutKiloCode.title": "О Relay",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Relay — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutKiloCode.extensionName": "Расширение Relay",
  ...
  "settings.language.description": "Выберите язык интерфейса Relay. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Relay, включая API-ключи провайдеров и модель по умолчанию.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Relay",
