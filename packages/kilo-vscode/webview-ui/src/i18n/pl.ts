export const dict = {
  ...
  "deviceAuth.title": "Zaloguj się do Relay",
  ...
  "profile.action.login": "Zaloguj się przez Relay",
  ...
  "settings.aboutKiloCode.title": "O Relay",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Relay to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.extensionName": "Rozszerzenie Relay",
  ...
  "settings.language.description": 'Wybierz język interfejsu Relay. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Relay, w tym klucze API dostawców i domyślny model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Relay",
