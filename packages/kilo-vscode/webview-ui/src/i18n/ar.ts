export const dict = {
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Relay",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Relay",
  ...
  "settings.aboutKiloCode.title": "حول Relay",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Relay هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutKiloCode.extensionName": "إضافة Relay",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Relay. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Relay، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Relay",
