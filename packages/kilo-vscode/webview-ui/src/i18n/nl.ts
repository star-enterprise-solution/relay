export const dict = {
  ...
  "deviceAuth.title": "Meld je aan bij Relay",
  ...
  "profile.action.login": "Inloggen met Relay",
  ...
  "settings.aboutKiloCode.title": "Over Relay",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Relay is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutKiloCode.extensionName": "Relay Extensie",
  ...
  "settings.language.description": 'Kies de taal voor de Relay UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Relay, inclusief provider API-sleutels en standaard model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Relay",
