...
export const dict = {
  ...
  "profile.action.login": "使用 Relay 登录",
  ...
  "settings.aboutKiloCode.title": "关于 Relay",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Relay 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "Relay 扩展",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Relay 界面的语言。',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 Relay 安装迁移设置，包括提供商 API 密钥和默认模型。",
