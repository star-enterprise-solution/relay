...
export const dict = {
  ...
  "profile.action.login": "Relay로 로그인",
  ...
  "settings.aboutKiloCode.title": "Relay 정보",
  ...
  "session.messages.welcome":
    "Relay는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutKiloCode.extensionName": "Relay 확장 프로그램",
  ...
  "settings.language.description": 'Relay UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 Relay 설치에서 설정을 마이그레이션합니다.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Relay의 새로운 기능",
