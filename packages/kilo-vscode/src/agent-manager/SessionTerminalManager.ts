...
export class SessionTerminalManager {
  ...
  constructor(
    ...
    this.disposables.push(
      ...
      host.onActiveTerminalChanged((terminal) => {
        ...
        void host.setContext("relay.agentTerminalFocus", managed)
      }),
    )
  ...
  dispose(): void {
    void this.host.setContext("relay.agentTerminalFocus", false)
  ...
  private updateContextKey(): void {
    ...
    void this.host.setContext("relay.agentTerminalFocus", managed)
  }
